...
#         return (interpolate.interp1d(x_interp, Q_approx(x_interp, Q_param, mpi, Lambda_b_true) * Lambda_b / lambda_var))(X)
        ...
        obs_names_list = ['SGT', 'DSG', 'spins']
        obs_labels_list = obs_names_list
        obs_names_data_dict = {'SGT' : [SGT], 
                              'DSG' : [DSG], 
        ...
        for obs_name in obs_names_list:
            obs_data = obs_names_data_dict[obs_name]
            
            for order_counter in range(1, orders_num + 1):
                ...
                try:
                    ...
                    for obs in obs_data:
                        ...
                        # print(SGT[self.nn_orders_mask, :].shape)
                        # print((SGT[self.nn_orders_mask, :])[self.mask_restricted, :].shape)
                        obs = (obs[self.raw_data_mask, :])[:, np.isin(t_lab, t_lab_Lb)]
                        # print("sgt_Lb has shape " + str(sgt_Lb.shape))
                        # print(t_lab_Lb)
